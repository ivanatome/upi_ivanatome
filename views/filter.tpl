...
<body>
  ...
  <br>
  <label for=""><strong>Objava: </strong>{{row[2]}}</label>
  <br>
  ...
  <a href="likee{{row[2]}}"><button  name="lajk"  value ="lajk" class="lajk" style="background-color: skyblue;" >Like</button></a> 
  <form action="/komm{{row[2]}}" method="POST" class="zapozadinu" width="140px" >
    <input type="text" name="textkomm" method='POST' placeholder="Unesi komentar"><a href="komm{{row[2]}}"><input type="submit" name='ime' style="background-color: springgreen;"></a>
